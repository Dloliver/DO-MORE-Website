...
const serviceDefaults = {
  prototype: 'Prototype or product planning',
  mvp: 'MVP development',
  custom: 'Custom application',
  support: 'Ongoing product support',
}
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus({
        type: 'success',
        message:
          'Your project inquiry has been submitted. We’ll review it and reply with the best next step.',
      })
    } catch {
      setStatus({
        type: 'error',
        message: `Your project could not be submitted. Please email ${CONTACT_EMAIL} directly.`,
      })
    }
  }
  ...
  return (
    ...
    >
      ...
      <input
        type="hidden"
        name="subject"
        value="New custom project inquiry from domoreatl.com"
      />
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm leading-6 text-white/48">
          This form does not create an appointment or payment obligation.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-xs font-bold uppercase tracking-[.14em] text-white/55">
          ...
          >
            ...
            <option>Prototype or product planning</option>
      ...
      <label className="mt-4 block text-xs font-bold uppercase tracking-[.14em] text-white/55">
        ...
        <textarea
          ...
          name="project"
          placeholder="Describe the idea, problem, or product."
          required
        />
      </label>
      ...
      <label className="mt-4 block text-xs font-bold uppercase tracking-[.14em] text-white/55">
        ...
        <textarea
          ...
          name="audience"
          placeholder="Tell us about the intended users or customers."
          required
        />
      </label>
      ...
      <label className="mt-4 block text-xs font-bold uppercase tracking-[.14em] text-white/55">
        ...
        <textarea
          ...
          name="features"
          placeholder="What must the first version be able to do?"
        />
      </label>
      ...
      <label className="mt-4 block text-xs font-bold uppercase tracking-[.14em] text-white/55">
        ...
        <input
          ...
          type="url"
          name="links"
          placeholder="Figma, Google Drive, existing website, requirements, or mockups"
        />
      </label>
      ...
      <label className="mt-4 block text-xs font-bold uppercase tracking-[.14em] text-white/55">
        ...
        <textarea
          ...
          placeholder="Constraints, goals, concerns, or questions."
        />
      </label>
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p className="text-xs leading-5 text-white/38 sm:max-w-[20rem] sm:text-right">
          No payment is collected through this form. Approved projects receive
          a proposal, contract, and private Stripe invoice.
        </p>
      </div>
