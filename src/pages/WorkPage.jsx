...
export default function WorkPage() {
  return (
    <>
      <PageHero eyebrow="Our Work" title="Products are stronger when the thinking behind them is visible." text="We build our own products, too. Explore original work across games, streaming tools, civic technology, and sports strategy—each built from concept through working software." primary={{ label: 'Start Your Project', to: '/start' }} secondary={{ label: 'Explore Services', to: '/services' }} />
